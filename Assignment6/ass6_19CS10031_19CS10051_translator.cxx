...
void quads::print_quad(ofstream &outputfile)
{
	...
	else if (CtoI <= op && op <= CtoD)
	{
		...
		{
		case CtoI:
			outputfile << " ChartoInt(" << arg1;
			outputfile << ")" << endl;
			break;
		case DtoC:
			outputfile << " DoubletoChar(" << arg1;
			outputfile << ")" << endl;
			break;
		case ItoD:
			outputfile << " InttoDouble(" << arg1;
			outputfile << ")" << endl;
			break;
		case ItoC:
			outputfile << " InttoChar(" << arg1;
			outputfile << ")" << endl;
			break;
		case CtoD:
			outputfile << " ChartoDouble(" << arg1;
			outputfile << ")" << endl;
			break;
		case DtoI:
			outputfile << " DoubletoInt(" << arg1;
			outputfile << ")" << endl;
			break;
		}
	}
...
void quads::print_quad()
{
	...
	else if (CtoI <= op && op <= CtoD)
	{
		...
		case CtoI:
			...
			break;
		case DtoC:
			cout << " DoubletoChar(" << arg1;
			cout << ")" << endl;
			break;
		case ItoD:
			cout << " InttoDouble(" << arg1;
			cout << ")" << endl;
			break;
		case ItoC:
			cout << " InttoChar(" << arg1;
			...
			break;
		case CtoD:
			cout << " ChartoDouble(" << arg1;
			cout << ")" << endl;
			break;
		case DtoI:
			cout << " DoubletoInt(" << arg1;
			cout << ")" << endl;
			break;
		}
	}
...
void quad_array::emit(string res, string arg1, string arg2, opcode op)
{
	...
	weight++;
	list_of_quads.push_back(insert);
	next_inst += weight;
}
